...
(function($) {
    ...
    jQuery("body").prepend("<a href='#' class='ot-menu-toggle'><i class='fa fa-bars'></i>Открыть меню</a>").prepend("<ul id='ot-menu-list' class='ot-menu-list'></ul>").find("#ot-menu-list").html(_ot_menulist);
