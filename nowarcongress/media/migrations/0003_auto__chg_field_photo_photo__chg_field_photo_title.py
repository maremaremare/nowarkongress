...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'media_photo', 'photo', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True))

        # Changing field 'Photo.title'
        db.alter_column(u'media_photo', 'title', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Photo.photo'
        db.alter_column(u'media_photo', 'photo', self.gf('django.db.models.fields.files.ImageField')(max_length=100))
        ...
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'Photo.title'
        db.alter_column(u'media_photo', 'title', self.gf('django.db.models.fields.CharField')(max_length=100))
    ...
    models = {
        ...
        u'media.video': {
            ...
            'content': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'videos'", 'to': u"orm['content.ContentItem']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'title': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
