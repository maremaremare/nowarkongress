...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'person_person', 'email', self.gf('django.db.models.fields.EmailField')(max_length=75, null=True))
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'Person.email'
        raise RuntimeError("Cannot reverse this migration. 'Person.email' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'Person.email'
        db.alter_column(u'person_person', 'email', self.gf('django.db.models.fields.EmailField')(max_length=75))
