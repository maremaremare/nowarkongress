...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'person_person', 'photo', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Person.photo'
        raise RuntimeError("Cannot reverse this migration. 'Person.photo' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'Person.photo'
        db.alter_column(u'person_person', 'photo', self.gf('django.db.models.fields.files.ImageField')(max_length=100))
