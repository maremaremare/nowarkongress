...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'person_person', 'name')

        # Deleting field 'Person.subscribed'
        db.delete_column(u'person_person', 'subscribed')
    ...
    def backwards(self, orm):
        ...
        db.add_column(u'person_person', 'name',
                      self.gf('django.db.models.fields.CharField')(max_length=200),
                      keep_default=False)


        # User chose to not deal with backwards NULL issues for 'Person.subscribed'
        raise RuntimeError("Cannot reverse this migration. 'Person.subscribed' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'Person.subscribed'
        db.add_column(u'person_person', 'subscribed',
