...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'person_person', 'first_name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=200),
                      keep_default=False)

        # Adding field 'Person.second_name'
        db.add_column(u'person_person', 'second_name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=200),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'person_person', 'first_name')

        # Deleting field 'Person.second_name'
        db.delete_column(u'person_person', 'second_name')
