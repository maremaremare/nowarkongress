...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_table(db.shorten_name(u'events_petition_participants'))

        # Removing M2M table for field outerparticipants on 'Petition'
        db.delete_table(db.shorten_name(u'events_petition_outerparticipants'))

        # Deleting model 'OuterParticipant'
        db.delete_table(u'events_outerparticipant')
    ...
    def backwards(self, orm):
        ...
        db.create_table(u'events_petition', (
            ...
            ('text', self.gf('django.db.models.fields.related.ForeignKey')(related_name='petition', to=orm['content.ContentItem'])),
        ...
        m2m_table_name = db.shorten_name(u'events_petition_participants')
        ...
        # Adding M2M table for field outerparticipants on 'Petition'
        m2m_table_name = db.shorten_name(u'events_petition_outerparticipants')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('petition', models.ForeignKey(orm[u'events.petition'], null=False)),
            ('outerparticipant', models.ForeignKey(orm[u'events.outerparticipant'], null=False))
        ))
        db.create_unique(m2m_table_name, ['petition_id', 'outerparticipant_id'])

        # Adding model 'OuterParticipant'
        db.create_table(u'events_outerparticipant', (
            ('occupation', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('city', self.gf('django.db.models.fields.CharField')(max_length=50)),
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=50)),
        ))
        db.send_create_signal(u'events', ['OuterParticipant'])
    ...
    models = {
        ...
        u'content.petition': {
            ...
            'participants': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'petition'", 'null': 'True', 'symmetrical': 'False', 'to': u"orm['person.Person']"}),
