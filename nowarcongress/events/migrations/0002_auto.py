...
class Migration(SchemaMigration):
    ...
    models = {
        ...
        u'events.eventitem': {
            ...
            'announcement': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'an_event'", 'to': u"orm['content.ContentItem']"}),
            'date': ('django.db.models.fields.DateField', [], {}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'lectures': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'lec_event'", 'symmetrical': 'False', 'to': u"orm['content.ContentItem']"}),
            'participants': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['person.Person']", 'symmetrical': 'False'}),
            'report': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'rep_event'", 'to': u"orm['content.ContentItem']"}),
