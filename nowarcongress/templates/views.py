...
class HomePageView(SearchView, TemplateView):
    ...
    def get_context_data(self, **kwargs):
        ...
        context['slider'] = ActualSlider.objects.latest('date')
...
class MainAboutView(TemplateView):
    template_name = 'main_about_view.html'

    def get_context_data(self, **kwargs):

        #context['petitions'] = ContentItem.objects.get(id = 66) + ContentItem.objects.get(id=55)
        context['members_about'] = ContentItem.objects.filter()
