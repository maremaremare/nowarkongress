...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'main_quote', 'text', self.gf('django.db.models.fields.CharField')(max_length=190))

    def backwards(self, orm):

        # Changing field 'Quote.text'
        db.alter_column(u'main_quote', 'text', self.gf('django.db.models.fields.TextField')())
