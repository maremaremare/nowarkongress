...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SliderItem.slider_order'
        db.add_column(u'main_slideritem', 'slider_order',
                      self.gf('django.db.models.fields.IntegerField')(default=1),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SliderItem.slider_order'
        db.delete_column(u'main_slideritem', 'slider_order')
    ...
    models = {
        ...
        u'content.outerparticipant': {
            'Meta': {'ordering': "['order', 'added']", 'object_name': 'OuterParticipant'},
        ...
        u'main.quote': {
            ...
            'author_pic': ('filebrowser.fields.FileBrowseField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'}),
            'full': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['content.ContentItem']", 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'text': ('django.db.models.fields.CharField', [], {'max_length': '190'})
        },
        u'main.slideritem': {
            'Meta': {'ordering': "['slider_order']", 'object_name': 'SliderItem'},
            ...
            'order': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True'}),
            'slider_order': ('django.db.models.fields.IntegerField', [], {})
        },
        u'person.person': {
