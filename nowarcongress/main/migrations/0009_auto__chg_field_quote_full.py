...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Quote.full'
        db.alter_column(u'main_quote', 'full_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['content.ContentItem'], null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Quote.full'
        raise RuntimeError("Cannot reverse this migration. 'Quote.full' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'Quote.full'
        db.alter_column(u'main_quote', 'full_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['content.ContentItem']))
