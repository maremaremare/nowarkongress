...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'SliderItem.photo'
        db.delete_column(u'main_slideritem', 'photo_id')

        # Adding field 'SliderItem.image'
        db.add_column(u'main_slideritem', 'image',
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'SliderItem.photo'
        raise RuntimeError("Cannot reverse this migration. 'SliderItem.photo' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'SliderItem.photo'
        db.add_column(u'main_slideritem', 'photo',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='slideritem', to=orm['media.Photo']),
                      keep_default=False)

        # Deleting field 'SliderItem.image'
        db.delete_column(u'main_slideritem', 'image')
