...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Renaming column for 'Quote.author_pic' to match new field type.
        db.rename_column(u'main_quote', 'author_pic_id', 'author_pic')
        # Changing field 'Quote.author_pic'
        db.alter_column(u'main_quote', 'author_pic', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True))
        # Removing index on 'Quote', fields ['author_pic']
        db.delete_index(u'main_quote', ['author_pic_id'])


    def backwards(self, orm):
        # Adding index on 'Quote', fields ['author_pic']
        db.create_index(u'main_quote', ['author_pic_id'])


        # Renaming column for 'Quote.author_pic' to match new field type.
        db.rename_column(u'main_quote', 'author_pic', 'author_pic_id')
        # Changing field 'Quote.author_pic'
        db.alter_column(u'main_quote', 'author_pic_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['media.Photo'], null=True))
