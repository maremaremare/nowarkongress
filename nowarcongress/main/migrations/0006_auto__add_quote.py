...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Quote'
        db.create_table(u'main_quote', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('text', self.gf('django.db.models.fields.TextField')()),
            ('author_name', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('author_pic', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['media.Photo'])),
            ('full', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['content.ContentItem'])),
        ))
        db.send_create_signal(u'main', ['Quote'])


    def backwards(self, orm):
        # Deleting model 'Quote'
        db.delete_table(u'main_quote')
    ...
    models = {
        ...
        u'main.quote': {
            ...
            'author_pic': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['media.Photo']"}),
