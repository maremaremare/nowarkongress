...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Partner.icon'
        db.delete_column(u'main_partner', 'icon')

        # Deleting field 'Quote.author_pic'
        db.delete_column(u'main_quote', 'author_pic_id')


    def backwards(self, orm):
        # Adding field 'Partner.icon'
        db.add_column(u'main_partner', 'icon',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)


        # User chose to not deal with backwards NULL issues for 'Quote.author_pic'
        raise RuntimeError("Cannot reverse this migration. 'Quote.author_pic' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'Quote.author_pic'
        db.add_column(u'main_quote', 'author_pic',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['media.Photo']),
                      keep_default=False)
    ...
    models = {
        ...
        u'main.quote': {
            ...
            'full': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['content.ContentItem']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'text': ('django.db.models.fields.TextField', [], {})
        },
        u'main.slideritem': {
        ...
        u'media.photo': {
            ...
            'content': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'photos'", 'to': u"orm['content.ContentItem']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
