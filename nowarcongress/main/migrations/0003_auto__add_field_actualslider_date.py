...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ActualSlider.date'
        db.add_column(u'main_actualslider', 'date',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2014, 6, 14, 0, 0)),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ActualSlider.date'
        db.delete_column(u'main_actualslider', 'date')
