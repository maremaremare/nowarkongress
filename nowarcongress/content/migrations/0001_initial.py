...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'content_contentcategory', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('icon', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('item_template', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('detail_template', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('list_template', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('slug', self.gf('django.db.models.fields.SlugField')(max_length=50)),
        ))
        db.send_create_signal(u'content', ['ContentCategory'])

        # Adding model 'ContentItem'
        db.create_table(u'content_contentitem', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('text', self.gf('django.db.models.fields.TextField')()),
            ('date', self.gf('django.db.models.fields.DateTimeField')()),
            ('category', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['content.ContentCategory'])),
            ('author', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['person.Person'], null=True, blank=True)),
            ('source', self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True)),
            ('comments_enabled', self.gf('django.db.models.fields.BooleanField')()),
        ))
        db.send_create_signal(u'content', ['ContentItem'])


    def backwards(self, orm):
        # Deleting model 'ContentCategory'
        db.delete_table(u'content_contentcategory')

        # Deleting model 'ContentItem'
        db.delete_table(u'content_contentitem')
    ...
    models = {
        ...
        u'content.contentitem': {
            ...
            'author': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['person.Person']", 'null': 'True', 'blank': 'True'}),
            'category': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['content.ContentCategory']"}),
