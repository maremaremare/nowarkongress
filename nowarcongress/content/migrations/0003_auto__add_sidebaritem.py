...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'content_sidebaritem', (
        ...
        db.send_create_signal(u'content', ['SidebarItem'])

        # Adding M2M table for field sidebar on 'ContentCategory'
        m2m_table_name = db.shorten_name(u'content_contentcategory_sidebar')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('contentcategory', models.ForeignKey(orm[u'content.contentcategory'], null=False)),
            ('sidebaritem', models.ForeignKey(orm[u'content.sidebaritem'], null=False))
        ))
        db.create_unique(m2m_table_name, ['contentcategory_id', 'sidebaritem_id'])


    def backwards(self, orm):
        # Deleting model 'SidebarItem'
        db.delete_table(u'content_sidebaritem')

        # Removing M2M table for field sidebar on 'ContentCategory'
        db.delete_table(db.shorten_name(u'content_contentcategory_sidebar'))
