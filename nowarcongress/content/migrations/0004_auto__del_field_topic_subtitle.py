...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Topic.subtitle'
        db.delete_column(u'content_topic', 'subtitle')


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Topic.subtitle'
        raise RuntimeError("Cannot reverse this migration. 'Topic.subtitle' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'Topic.subtitle'
        db.add_column(u'content_topic', 'subtitle',
