...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'OuterParticipant.occupation'
        db.alter_column(u'content_outerparticipant', 'occupation', self.gf('django.db.models.fields.CharField')(max_length=250))

    def backwards(self, orm):

        # Changing field 'OuterParticipant.occupation'
        db.alter_column(u'content_outerparticipant', 'occupation', self.gf('django.db.models.fields.CharField')(max_length=50))
