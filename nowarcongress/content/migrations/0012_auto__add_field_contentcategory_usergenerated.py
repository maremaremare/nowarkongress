...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ContentCategory.usergenerated'
        db.add_column(u'content_contentcategory', 'usergenerated',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ContentCategory.usergenerated'
        db.delete_column(u'content_contentcategory', 'usergenerated')
