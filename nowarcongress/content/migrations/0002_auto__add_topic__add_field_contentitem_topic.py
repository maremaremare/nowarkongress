...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'content_topic', (
            ...
            ('parent', self.gf('mptt.fields.TreeForeignKey')(blank=True, related_name='children', null=True, to=orm['content.Topic'])),
        ...
        # Adding field 'ContentItem.topic'
        db.add_column(u'content_contentitem', 'topic',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['content.Topic'], null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'ContentItem.topic'
        db.delete_column(u'content_contentitem', 'topic_id')
    ...
    models = {
        ...
        u'content.contentitem': {
            ...
            'topic': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['content.Topic']", 'null': 'True', 'blank': 'True'})
        },
        u'content.topic': {
