...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'SidebarItem.object_id'
        db.alter_column(u'content_sidebaritem', 'object_id', self.gf('django.db.models.fields.PositiveIntegerField')(null=True))
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'SidebarItem.object_id'
        raise RuntimeError("Cannot reverse this migration. 'SidebarItem.object_id' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'SidebarItem.object_id'
        db.alter_column(u'content_sidebaritem', 'object_id', self.gf('django.db.models.fields.PositiveIntegerField')())
