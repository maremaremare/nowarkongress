...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ContentItem.date'
        db.alter_column(u'content_contentitem', 'date', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))
        # Deleting field 'OuterParticipant.name'
        db.delete_column(u'content_outerparticipant', 'name')

        # Adding field 'OuterParticipant.first_name'
        db.add_column(u'content_outerparticipant', 'first_name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=50),
                      keep_default=False)

        # Adding field 'OuterParticipant.second_name'
        db.add_column(u'content_outerparticipant', 'second_name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=50),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Changing field 'ContentItem.date'
        db.alter_column(u'content_contentitem', 'date', self.gf('django.db.models.fields.DateTimeField')())
        # Adding field 'OuterParticipant.name'
        db.add_column(u'content_outerparticipant', 'name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=50),
                      keep_default=False)

        # Deleting field 'OuterParticipant.first_name'
        db.delete_column(u'content_outerparticipant', 'first_name')

        # Deleting field 'OuterParticipant.second_name'
        db.delete_column(u'content_outerparticipant', 'second_name')
