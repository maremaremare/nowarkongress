...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'OuterParticipant.email'
        db.add_column(u'content_outerparticipant', 'email',
                      self.gf('django.db.models.fields.EmailField')(default='no@email.yet', max_length=75),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'OuterParticipant.email'
        db.delete_column(u'content_outerparticipant', 'email')
    ...
    models = {
        ...
        u'content.outerparticipant': {
            ...
            'email': ('django.db.models.fields.EmailField', [], {'default': "'no@email.yet'", 'max_length': '75'}),
