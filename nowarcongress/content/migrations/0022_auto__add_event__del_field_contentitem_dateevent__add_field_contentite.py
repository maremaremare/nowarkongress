...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'ContentItem.dateevent'
        db.delete_column(u'content_contentitem', 'dateevent')

        # Adding field 'ContentItem.event'
        db.add_column(u'content_contentitem', 'event',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='contentitem', null=True, to=orm['content.Event']),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Adding field 'ContentItem.dateevent'
        db.add_column(u'content_contentitem', 'dateevent',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)

        # Deleting field 'ContentItem.event'
        db.delete_column(u'content_contentitem', 'event_id')
