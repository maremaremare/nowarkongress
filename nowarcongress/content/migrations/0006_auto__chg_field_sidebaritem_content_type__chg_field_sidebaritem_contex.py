...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'SidebarItem.content_type'
        db.alter_column(u'content_sidebaritem', 'content_type_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['contenttypes.ContentType'], null=True))

        # Changing field 'SidebarItem.context_name'
        db.alter_column(u'content_sidebaritem', 'context_name', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'SidebarItem.content_type'
        raise RuntimeError("Cannot reverse this migration. 'SidebarItem.content_type' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'SidebarItem.content_type'
        db.alter_column(u'content_sidebaritem', 'content_type_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['contenttypes.ContentType']))

        # User chose to not deal with backwards NULL issues for 'SidebarItem.context_name'
        raise RuntimeError("Cannot reverse this migration. 'SidebarItem.context_name' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'SidebarItem.context_name'
        db.alter_column(u'content_sidebaritem', 'context_name', self.gf('django.db.models.fields.CharField')(max_length=50))
