...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SidebarItem.for_detail_only'
        db.add_column(u'content_sidebaritem', 'for_detail_only',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SidebarItem.for_detail_only'
        db.delete_column(u'content_sidebaritem', 'for_detail_only')
