...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'OuterParticipant.order'
        db.add_column(u'content_outerparticipant', 'order',
                      self.gf('django.db.models.fields.IntegerField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'OuterParticipant.order'
        db.delete_column(u'content_outerparticipant', 'order')
