...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'OuterParticipant.is_shown'
        db.add_column(u'content_outerparticipant', 'is_shown',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'OuterParticipant.added'
        db.add_column(u'content_outerparticipant', 'added',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'OuterParticipant.is_shown'
        db.delete_column(u'content_outerparticipant', 'is_shown')

        # Deleting field 'OuterParticipant.added'
        db.delete_column(u'content_outerparticipant', 'added')
    ...
    models = {
        ...
        u'content.outerparticipant': {
            'Meta': {'ordering': "['second_name']", 'object_name': 'OuterParticipant'},
