...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'content_topic', u'lft')

        # Deleting field 'Topic.parent'
        db.delete_column(u'content_topic', 'parent_id')

        # Deleting field 'Topic.level'
        db.delete_column(u'content_topic', u'level')

        # Deleting field 'Topic.rght'
        db.delete_column(u'content_topic', u'rght')

        # Deleting field 'Topic.tree_id'
        db.delete_column(u'content_topic', u'tree_id')
    ...
    def backwards(self, orm):
        ...
        db.add_column(u'content_topic', u'lft',
                      self.gf('django.db.models.fields.PositiveIntegerField')(db_index=True),
                      keep_default=False)

        # Adding field 'Topic.parent'
        db.add_column(u'content_topic', 'parent',
                      self.gf('mptt.fields.TreeForeignKey')(related_name='children', null=True, to=orm['content.Topic'], blank=True),
                      keep_default=False)
        ...
        db.add_column(u'content_topic', u'level',
                      self.gf('django.db.models.fields.PositiveIntegerField')(db_index=True),
                      keep_default=False)
        ...
        db.add_column(u'content_topic', u'rght',
                      self.gf('django.db.models.fields.PositiveIntegerField')(db_index=True),
                      keep_default=False)
        ...
        db.add_column(u'content_topic', u'tree_id',
                      self.gf('django.db.models.fields.PositiveIntegerField')(db_index=True),
                      keep_default=False)
