...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'SidebarItem.context_name'
        db.delete_column(u'content_sidebaritem', 'context_name')

        # Adding field 'SidebarItem.object_id'
        db.add_column(u'content_sidebaritem', 'object_id',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=1),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'SidebarItem.context_name'
        db.add_column(u'content_sidebaritem', 'context_name',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'SidebarItem.object_id'
        db.delete_column(u'content_sidebaritem', 'object_id')
