...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ContentItem.visible'
        db.add_column(u'content_contentitem', 'visible',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ContentItem.visible'
        db.delete_column(u'content_contentitem', 'visible')
